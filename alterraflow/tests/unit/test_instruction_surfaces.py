...
from alterraflow.drift.instruction_surfaces import build_instruction_surface_report
...
def _write_instruction_surfaces(root: Path) -> None:
    ...
    invocation_template_contents = {
        "pm_invocation.md": (
            ...
            "Execution mode:\n"
            "- If this handoff is run through alterraflow, the runtime-managed worktree and branch for this run are authoritative. Do not switch to main. Do not create another worktree. Do not create another branch.\n"
        ),
        "prd_spec_invocation.md": (
            "You are the PRD / Spec Author agent.\n"
            "Execution mode:\n"
            "- If this handoff is run through alterraflow, the runtime-managed worktree for this run is authoritative. Do not switch to `main`. Do not create another worktree. Do not create another branch.\n"
        ),
        ...
        "coding_invocation.md": (
            ...
            "Execution mode:\n"
            "- If this handoff is run through alterraflow, the runtime-managed worktree for this run is authoritative. Use the provided checkout context exactly as given, including any PR-head checkout or push target. Do not switch to main. Do not create another worktree. Do not create another branch.\n"
        ),
        "review_invocation.md": (
            "You are the Review Agent.\n"
            "Execution mode:\n"
            "- If this handoff is run through alterraflow, the runtime-managed review worktree for this run is authoritative. Use the provided checkout context exactly as given, including any PR-head checkout or push target. Do not switch to main. Do not create another worktree. Do not create another branch.\n"
        ),
