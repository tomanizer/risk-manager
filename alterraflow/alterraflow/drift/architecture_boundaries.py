...
_FORBIDDEN_IMPORTS: dict[str, tuple[_ScopeRule, ...]] = {
    "module": (
        ...
        _ScopeRule("alterraflow", "module_imports_runtime_surface", "Module code must not import runtime surfaces."),
    ),
    "walker": (
        _ScopeRule(
            "src.orchestrators",
        ...
        _ScopeRule("alterraflow", "walker_imports_runtime_surface", "Walker code must not import runtime surfaces."),
    ),
    "orchestrator": (
        _ScopeRule(
            "alterraflow",
    ...
    "ui": (
        ...
        _ScopeRule("alterraflow", "ui_imports_runtime_surface", "UI code must not import runtime surfaces."),
    ),
    "runtime": (
