...
def build_issue_planner_prompt(input_data: IssuePlannerRunnerInput) -> str:
    prompt = (
        ...
        "If dispatched by alterraflow, treat the allocated worktree as authoritative and do not switch to `main`, "
        "create another worktree, or create another branch.\n"
        "If running manually outside alterraflow, refresh current `main` and create a fresh branch from current `main` before editing work items.\n"
        "Read:\n"
        "- AGENTS.md\n"
