...
from alterraflow.handoff_bundle import refresh_handoff_bundle_runtime_metadata
from alterraflow.runners.contracts import RunnerExecution
...
def _inject_runtime_checkout_context(prompt: str, lease: WorktreeLeaseRecord, metadata: dict[str, str]) -> str:
    context_block = (
        "Execution checkout (alterraflow authoritative):\n"
