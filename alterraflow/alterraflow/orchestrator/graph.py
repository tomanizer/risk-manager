...
from alterraflow.config.defaults import RuntimeDefaults, build_defaults
from alterraflow.drift.backlog_materialization import build_backlog_materialization_report
from alterraflow.notifications.slack import notify_human_gate, notify_runner_failed, send_morning_digest
from alterraflow.orchestrator.execution import build_runner_execution
from alterraflow.orchestrator.prd_bootstrap import load_prd_bootstrap_candidates
from alterraflow.orchestrator.pr_publication import maybe_publish_completed_coding_run
from alterraflow.orchestrator.supervisor import (
    classify_loop_payload,
    record_supervisor_heartbeat,
    sleep_for_poll_interval,
    supervisor_lock,
)
from alterraflow.orchestrator.worktree_manager import allocate_worktree, bind_worktree_to_execution, release_worktree
...
def main() -> int:
    ...
    try:
        from alterraflow.telemetry import configure_telemetry
