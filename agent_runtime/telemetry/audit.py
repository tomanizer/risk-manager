...
from agent_runtime.telemetry._compat import get_logger
from agent_runtime.telemetry.spans import current_trace_context
...
def emit_audit_event(
    ...
    *,
    ...
    component:
        Dotted component identifier, e.g. ``"agent_runtime.orchestrator"``.
    payload:
...
def _write_sqlite(
    *,
    ...
    try:
        from agent_runtime.storage.sqlite import TelemetryEventRecord, append_telemetry_event
