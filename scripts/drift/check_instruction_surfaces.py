...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scan instruction surfaces for deterministic role-coverage and governance drift.")
...
def main() -> int:
    ...
    report = build_instruction_surface_report(scan_root)
