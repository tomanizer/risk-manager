...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scan canon lineage for deterministic active-vs-archived document drift.")
...
def main() -> int:
    ...
    report = build_canon_lineage_report(scan_root)
