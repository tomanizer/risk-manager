...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scan the current-state registry for deterministic implementation alignment drift.")
...
def main() -> int:
    ...
    report = build_registry_alignment_report(scan_root)
